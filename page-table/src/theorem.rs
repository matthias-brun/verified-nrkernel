...
use crate::spec_t::os;
use crate::spec_t::mmu::defs::{ MemOp, PTE, Core, Flags, PkruRegister };
...
pub enum RLbl {
    Tau,
    MemOp           { thread_id: nat, core: Core, vaddr: nat, op: MemOp },
    WrPkru          { thread_id: nat, core: Core, val: PkruRegister},
    ...
    ProtectStart    { thread_id: nat, vaddr: nat, flags: Flags, pkey: nat },
