...
pub open spec fn candidate_mapping_in_bounds_pmem(c: cas_mmu::Constants, pte: PTE) -> bool {
...
pub struct PTE {
    ...
    /// `spec_t::cas_mmu::rl3`.) However, because we always set the flags on directories to be
