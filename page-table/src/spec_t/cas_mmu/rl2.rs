...
use crate::spec_t::cas_mmu::defs::{ Core, PTE };
use crate::spec_t::cas_mmu::rl3::{ Writes };
use crate::spec_t::cas_mmu::translation::{
...
{
    reveal(State::wf_ptmem_range);
    assert forall |c| #[trigger]post.cores.contains_key(c) implies post.cores[c].wf() by {
...
pub mod refinement {
    ...
    #[cfg(verus_keep_ghost)]
    use crate::spec_t::cas_mmu::defs::{MAX_VIRTADDR, Pcid, Vaddr};
    use crate::extra;
